...
public class ModaModVariables {
	public ModaModVariables(ModaModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("moda", "player_variables"), new PlayerVariablesProvider());
	}
