...
import net.mcreator.moda.procedures.SpectatorProcedureProcedure;
...
public class SpectatorKeyBinding extends ModaModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SpectatorKeyBinding(ModaModElements instance) {
		super(instance, 18);
	...
	public void initElements() {
		keys = new KeyBinding("key.moda.spectator", GLFW.GLFW_KEY_K, "key.categories.movement");
		...
		if (type == 0) {
			{
				...
				SpectatorProcedureProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
