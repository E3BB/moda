...
import net.mcreator.moda.procedures.CreativeProcedureProcedure;
...
public class CreativeKeyBinding extends ModaModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public CreativeKeyBinding(ModaModElements instance) {
		super(instance, 19);
	...
	public void initElements() {
		keys = new KeyBinding("key.moda.creative", GLFW.GLFW_KEY_J, "key.categories.movement");
		...
		if (type == 0) {
			{
				...
				CreativeProcedureProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
