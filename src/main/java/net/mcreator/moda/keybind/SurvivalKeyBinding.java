...
import net.mcreator.moda.procedures.SurvivalProcedureProcedure;
...
public class SurvivalKeyBinding extends ModaModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SurvivalKeyBinding(ModaModElements instance) {
		super(instance, 15);
	...
	public void initElements() {
		keys = new KeyBinding("key.moda.survival", GLFW.GLFW_KEY_L, "key.categories.movement");
		...
		if (type == 0) {
			{
				...
				SurvivalProcedureProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
